...
package ada_main is
   ...
   u00198 : constant Version_32 := 16#a1812752#;
   ...
   u00200 : constant Version_32 := 16#a854ff75#;
   pragma Export (C, u00200, "odbB");
   u00201 : constant Version_32 := 16#02c305a2#;
   pragma Export (C, u00201, "odbS");
   u00202 : constant Version_32 := 16#ca632c0b#;
   pragma Export (C, u00202, "odb__object_idB");
   u00203 : constant Version_32 := 16#f645b533#;
   pragma Export (C, u00203, "odb__object_idS");
   u00204 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00204, "system__concat_4B");
   u00205 : constant Version_32 := 16#8aaaa71a#;
   pragma Export (C, u00205, "system__concat_4S");
   u00206 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00206, "system__concat_3B");
   u00207 : constant Version_32 := 16#ffbed09f#;
   pragma Export (C, u00207, "system__concat_3S");
   u00208 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00208, "system__concat_2B");
   u00209 : constant Version_32 := 16#f66e5bea#;
   pragma Export (C, u00209, "system__concat_2S");
   u00210 : constant Version_32 := 16#994daa60#;
   pragma Export (C, u00210, "system__pool_sizeB");
   u00211 : constant Version_32 := 16#f5e0c463#;
   pragma Export (C, u00211, "system__pool_sizeS");
   u00212 : constant Version_32 := 16#a61e2c37#;
   pragma Export (C, u00212, "odb__persistent_type_test_dataB");
   u00213 : constant Version_32 := 16#c4ee0df8#;
   pragma Export (C, u00213, "odb__persistent_type_test_dataS");
   u00214 : constant Version_32 := 16#269b1972#;
   pragma Export (C, u00214, "aunit__test_fixturesB");
   u00215 : constant Version_32 := 16#3b99f1a5#;
   pragma Export (C, u00215, "aunit__test_fixturesS");
   u00216 : constant Version_32 := 16#7c6ac93d#;
   pragma Export (C, u00216, "odb__persistent_type_test_data__persistent_type_testsB");
   u00217 : constant Version_32 := 16#0cb928b8#;
   pragma Export (C, u00217, "odb__persistent_type_test_data__persistent_type_testsS");
   u00218 : constant Version_32 := 16#b1f76a4e#;
   pragma Export (C, u00218, "odb__persistent_type_test_data__persistent_type_tests__suiteB");
   u00219 : constant Version_32 := 16#5eff3ac7#;
   pragma Export (C, u00219, "odb__persistent_type_test_data__persistent_type_tests__suiteS");
   ...
   --  odb.object_id%b
   --  odb%b
   --  odb.persistent_type_test_data%s
   --  odb.persistent_type_test_data%b
   --  odb.persistent_type_test_data.persistent_type_tests%s
   --  odb.persistent_type_test_data.persistent_type_tests%b
   --  odb.persistent_type_test_data.persistent_type_tests.suite%s
   --  odb.persistent_type_test_data.persistent_type_tests.suite%b
